...
export default function TabMain({ tabmainref, tabmainstatic, tabmainstyle }) {
  const { tabmainstate, settabmainstate } = useContext(Context);
  const ref = useRef();
  ...
  useEffect(() => {
    if (tabmainstatic) {
      const filter = tabmain.filter(
        (data) => data.tabmainid === tabmainstatic.tabmainid
      );
      const array = [];
  ...
  //     const articlefieldset = [
  //      {
  //        tabmaintitle: "All messages",
  //        tabmainrender: () => {
  //          return appFieldsetRender({
  //            // feedmainstatic:{feedmainid: 'messagearea', feedmainindex: 0}
  //            zoommainstatic: { zoommainid: "messageform" },
  ...
  //      },
  //      {
  //        tabmaintitle: "Read messages",
  //        tabmainrender: () => {
  //          return appFieldsetRender({
  //            // feedmainstatic:{feedmainid: 'messagearea', feedmainindex: 1}
  //            zoommainstatic: { zoommainid: "articleform" },
  //          });
  //        },
  //      },
  //    ];
    ...
    <div>
      <main className="">
            ...
            {tabmainrender?.map((data, index) => (
              <>
                <article
                  ...
                  className={`l-h4 border-b-[2.5px]  rounded-sm border-white dark:border-slate-800 duration-1000 ${
                    data?.tabmainindex === tabmainstate?.tabmainindex &&
                    "border-slate-700 dark:border-white text-black dark:text-white font-medium"
                  }`}
                >
                  <CardMain>
                    <div className="flex flex-row gap-2">
                      {data.tabmaintitle}
                      {/* {tabmainstatic?.tabmainid === "workoutfieldset" &&
                        index === 1 && (
                          <BadgeMain
                            badgemainstatic={{
                      ...
                      {tabmainstatic?.tabmainid === "clubfieldset" &&
                        index === 1 && (
                          <BadgeMain
                            badgemainstatic={{
                      ...
                      {tabmainstatic?.tabmainid === "favouritefieldset" &&
                        index === 0 && (
                          <BadgeMain
                            badgemainstatic={{
                      ...
                      {tabmainstatic?.tabmainid === "achievementfieldset" &&
                        index === 1 && (
                          <BadgeMain
                            badgemainstatic={{
                      ...
                      {tabmainstatic?.tabmainid === "messagefieldset" &&
                        index === 0 && (
                          <BadgeMain
                            badgemainstatic={{
                              badgemainid: "messagespan",
        ...
        <section className="no-scrollbar border-t dark:border-t-slate-700">
          ...
          <figure ref={ref}
            className={`w-screen md:w-full grid grid-flow-col justify-start  overflow-x-scroll overflow-y-clip no-scrollbar snap-x snap-mandatory scroll-smooth duration-100 ${
              tabmainstyle && tabmainstyle
            }`}
          >
...
// export function appFieldsetRenderTwo({ badgemainstatic}) {
//     return (
//       <div className="">
//         <section className="">
//           <BadgeMain badgemainstatic={badgemainstatic} />
//         </section>
//       </div>
//     );
//   }
